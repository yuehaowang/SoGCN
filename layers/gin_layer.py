...
class GINLayer(nn.Module):
    ...
    """
    def __init__(self, apply_func, aggr_type, dropout, batch_norm, residual=False, init_eps=0, learn_eps=False, activation=F.relu):
        super().__init__()
    ...
    def forward(self, g, h, intermediate=None):
    ...
    def forward(self, x):
        if self.linear_or_not:
            ...
            for i in range(self.num_layers - 1):
                h = self.activation(self.batch_norms[i](self.linears[i](h)))
